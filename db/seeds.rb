...
connection.execute("copy temp from '#{root_dir}/doc/rawdata/agency.txt' delimiters ',' csv header;")
...
connection.execute("copy temp from '#{root_dir}/doc/rawdata/calendar.txt' delimiters ',' csv header;")
...
connection.execute("copy temp from '#{root_dir}/doc/rawdata/calendar_dates.txt' delimiters ',' csv header;")
...
connection.execute("copy temp from '#{root_dir}/doc/rawdata/custom_landmarks.txt' delimiters ',' csv header;")
...
connection.execute("copy temp from '#{root_dir}/doc/rawdata/routes.txt' delimiters ',' csv header;")
...
connection.execute("copy temp from '#{root_dir}/doc/rawdata/stops.txt' delimiters ',' csv header;")
...
connection.execute("copy temp from '#{root_dir}/doc/rawdata/trips.txt' delimiters ',' csv header;")
...
connection.execute("copy temp from '#{root_dir}/doc/rawdata/shapes.txt' delimiters ',' csv header;")
...
connection.execute("copy temp from '#{root_dir}/doc/rawdata/stop_times.txt' delimiters ',' csv header;")
